...
public class TestMailer {
	...
	private String user="limyoonji93";
	private String tail="@naver.com";
	private String password="dbsdk0505@@";
	...
	private void sendingBody(Message msg, String receiver, String title, String text) throws Exception {
		...
		msg.setFrom(new InternetAddress("limyoonji93@naver.com")); // 발신자 셋팅 , 보내는 사람의 이메일주소를 한번 더 입력(user+tail)
